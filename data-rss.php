...
function od_display_data($od_object){
	...
	$rss_field_timestamp = $od_object->get_rss("timestamp"); // get the field used as RSS timestamp (this is needed)
	$rss_field_id = $od_object->get_rss("id"); // get the field used as RSS id
