	...
	<div id="content" role="main">
		<article id="post-2" class="page type-page status-publish hentry">
			<div class="entry-content">
				<?php if( od_have_data() ) : ?>
					<p><?php echo number_format(od_number_rows()); ?> out of <?php echo number_format(od_total_number_rows() ) ; ?> items found matching your criteria.</p>
					<?php od_get_filters('<p><strong>Filters applied:</strong></p><p>','</p>'); ?>
					<table>
						<thead>
							<tr>
								<?php od_the_columns() ; ?>
		...
		<?php od_get_filter_form(); ?>
		</article><!-- #post-0 -->
	</div><!-- #content -->
</div><!-- #primary -->
	
<?php get_sidebar(); // include the standard wordpress theme footer ?>
<?php get_footer(); // include the standard wordpress theme footer ?>
